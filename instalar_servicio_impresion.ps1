...
.DESCRIPTION
    Este script:
    1. Descarga automaticamente el agente (print-agent.js) desde el servidor en la nube
    2. Crea una Tarea Programada de Windows que inicia el agente al iniciar sesion
    3. El agente se reinicia automaticamente si falla
    4. No requiere abrir PowerShell ni nada manualmente despues de la instalacion
...
$PsScript   = "$InstallDir\print_raw.ps1"
